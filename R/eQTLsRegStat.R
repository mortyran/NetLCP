#' @title eQTLs on regulations statistics
#' @description eQTLs on regulations statistics
#'
...
#'
#' @examples
#' eQTLsRegStat(regData = NULL, eQTLsData = NULL, regulationType = "miRNA-mRNA", filterDegree = 40, , selectNode = NULL)
#' @export
eQTLsRegStat = function(regData = NULL, eQTLsData = NULL, regulationType = NULL, filterDegree = 40, selectNode = NULL){
